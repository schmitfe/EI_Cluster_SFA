...
if __name__ == '__main__':
    ...
    params = {'n_jobs': CPUcount, 'N_E': FactorSize * baseline['N_E'], 'N_I': FactorSize * baseline['N_I'], 'dt': 0.1,
              'neuron_type': 'gif_psc_exp', 'simtime': FactorTime * baseline['simtime'], 'delta_I_xE': 0.,
    ...
    EI_Network = ClusterModelGeNN.ClusteredNetworkGeNN_Timing(default, params, batch_size=1)
