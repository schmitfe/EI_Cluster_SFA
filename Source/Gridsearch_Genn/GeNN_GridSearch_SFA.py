...
if __name__ == '__main__':
    ...
    params = {'n_jobs': CPUcount, 'N_E': 20000, 'N_I': 5000, 'dt': 0.1, 'neuron_type': 'gif_psc_exp', 'simtime': 9000,
    ...
    NetworkModel = ClusteredNetworkGeNN_Grid(default, params, batch_size=batch_size,
                                         NModel=GeNN_Models.define_ReducedGIF_Ie_multibatch())
    ...
    Constructor=(
                ('Ix',[GlobE(0.95+0.05*ii) for ii in range(2)], (NetworkModel.get_populations()[0],)),
                ('Ix',[GlobI(0.7+0.025*ii) for ii in range(2)], (NetworkModel.get_populations()[1],)),
                )
